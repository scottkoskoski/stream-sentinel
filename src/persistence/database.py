...
from .config import ClickHouseConfig, PostgreSQLConfig, get_database_configs
from .schemas import AlertSeverity, AlertStatus, FraudAlert, TransactionRecord, UserStatus
...
class PostgreSQLManager:
    ...
    def upsert_user_account(
        ...
        increment_high_severity: bool = False,
    ) -> bool:
...
class ClickHouseManager:
    ...
    def batch_insert_transactions(self, transactions: List[TransactionRecord]) -> bool:
        ...
        try:
            ...
            self._client.execute("INSERT INTO transaction_records VALUES", data, types_check=True)
    ...
    def insert_fraud_features(
        self,
        transaction_id: str,
        user_id: str,
        features: Dict[str, float],
        feature_category: str = "realtime",
    ) -> bool:
        ...
        try:
            ...
            self._client.execute("INSERT INTO fraud_features VALUES", data, types_check=True)
    ...
    def insert_detection_result(
        ...
        try:
            ...
            self._client.execute("INSERT INTO detection_results VALUES", data, types_check=True)
    ...
    def insert_performance_metrics(self, metrics: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            self._client.execute("INSERT INTO performance_metrics VALUES", metrics, types_check=True)
...
class PersistenceLayer:
    ...
    def persist_fraud_detection_result(
        self,
        ...
        try:
            ...
            self.clickhouse.insert_fraud_features(transaction.transaction_id, transaction.user_id, features)
