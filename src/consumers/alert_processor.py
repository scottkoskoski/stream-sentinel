...
class AlertProcessor:
    ...
    def _analyze_transaction_pattern(
        self, alert: Dict[str, Any], historical_alerts: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
    ...
    def publish_response(self, alert_response: AlertResponse):
        ...
        try:
            ...
            # Include correlation ID in the response payload
            if TRACING_AVAILABLE:
                corr_id = TracingContext.current_correlation_id()
                if corr_id:
                    response_message["correlation_id"] = corr_id
