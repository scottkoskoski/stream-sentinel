...
class TestModelExportPipeline:
    ...
    @pytest.mark.skipif(
        not hasattr(sys.modules.get("onnx", None), "__version__"),
    ...
    def test_export_without_validation_data(self, model_exporter, trained_xgboost_model):
        ...
        onnx_path, validation_result = model_exporter.export_to_onnx(
            trained_xgboost_model, model_name="no_validation_test"
        )
...
class TestModelValidationIntegration:
    ...
    def test_accuracy_validation_integration(self, simple_xgboost_model, validation_data, tmp_path):
        ...
        export_config = ExportConfig(output_dir=str(tmp_path), validation_samples=100)

        exporter = ModelExporter(export_config)
        onnx_path, export_result = exporter.export_to_onnx(
            simple_xgboost_model, model_name="accuracy_test_model", X_validation=X_test
        )
        ...
        validation_result = accuracy_validator.validate_accuracy(simple_xgboost_model, onnx_path, X_test, y_test)
...
class TestBenchmarkingIntegration:
    ...
    def test_benchmark_config_validation(self):
        ...
        invalid_config = BenchmarkConfig(warmup_iterations=0, benchmark_iterations=5, load_test_duration_seconds=1)
    ...
    def test_single_threaded_benchmarking(self, benchmark_config, simple_predict_function, benchmark_data):
        ...
        result = benchmark.benchmark_model(simple_predict_function, benchmark_data, model_name="single_thread_test")
    ...
    def test_concurrent_benchmarking(self, benchmark_config, simple_predict_function, benchmark_data):
        ...
        result = benchmark.benchmark_model(simple_predict_function, benchmark_data, model_name="concurrent_test")
    ...
    def test_load_testing(self, benchmark_config, simple_predict_function, benchmark_data):
        ...
        result = benchmark.benchmark_model(simple_predict_function, benchmark_data, model_name="load_test")
    ...
    def test_benchmark_error_handling(self, benchmark_config, benchmark_data):
        ...
        result = benchmark.benchmark_model(failing_function, benchmark_data, model_name="error_test")
...
class TestCompleteServingPipeline:
    ...
    def test_complete_serving_pipeline(self, production_xgboost_model, complete_pipeline_data, tmp_path):
        ...
        performance_validator = PerformanceValidator(target_improvement_factor=1.0, max_acceptable_latency_ms=50.0)
        ...
        pipeline_success = (
            export_result.conversion_successful
            and accuracy_result.test_samples > 0
            and performance_result.python_mean_latency_ms > 0
            and benchmark_result.single_thread_metrics is not None
        )
