...
class TestModularPipelineIntegration:
    ...
    def test_config(self, temp_dir, mock_data):
        ...
        return TrainingConfig(
            ...
            monitoring=MonitoringConfig(log_level="DEBUG", log_dir=str(temp_dir / "logs"), enable_metrics=True),
            checkpointing={
    ...
    def test_logging_and_metrics(self, test_config):
        ...
        training_metrics.trial_completed(trial_number=1, score=0.85, duration=30.0, model_type="xgboost")
    ...
    def test_hyperparameter_optimizer(self, mock_xgb, mock_cv_score, test_config, mock_data):
        ...
        # Create optimizer
        optimizer = HyperparameterOptimizer(test_config.optimization.__dict__, checkpoint_manager)
    ...
    def test_pipeline_orchestrator(self, mock_xgb, mock_cv_score, test_config):
        ...
        checkpoint_manager = CheckpointManager(test_config.checkpointing)
        data_processor = DataProcessor(test_config.data.__dict__)
        hyperopt_optimizer = HyperparameterOptimizer(test_config.optimization.__dict__, checkpoint_manager)
