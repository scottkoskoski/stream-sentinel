    ...
    def log_performance_metrics(self) -> None:
        ...
        try:
            ...
            self.warning(
                ...
                extra={"reason": "psutil not available"},
            )


def timing_decorator(logger: Optional[TrainingLogger] = None, timer_name: Optional[str] = None):
    """
...
def configure_component_logger(component_name: str, config: Dict[str, Any]) -> TrainingLogger:
    """
...
def stage_logging(logger: TrainingLogger, stage_name: str, **context):
    ...
    with logger.context(**stage_context):
        ...
        try:
            ...
            logger.info(
                "stage.completed",
                extra={"stage_name": stage_name, "duration": duration},
            )
