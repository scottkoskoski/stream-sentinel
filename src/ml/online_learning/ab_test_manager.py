...
class ABTestExperiment:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        exp_dict["variants"] = [{**asdict(v), "variant_type": v.variant_type.value} for v in self.variants]
        return exp_dict
...
class ABTestManager:
    ...
    def create_experiment(
        ...
        description: str,
        hypothesis: str,
        control_model: Tuple[str, str],
        treatment_model: Tuple[str, str],
        ...
        try:
            ...
            target_sample_size = self._calculate_sample_size(minimum_effect_size, significance_level, 0.8)
        ...
        try:
            ...
            if p_value < experiment.significance_level:
                ...
                if (
                    ...
                    and abs(effect_size) < experiment.futility_threshold
                    and experiment.current_sample_size > experiment.target_sample_size * 0.5
                ):
            ...
            self.logger.info(
                f"Analyzed experiment {experiment.experiment_id}: "
    ...
    def get_ab_test_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_sample_size": (
                np.mean([exp["current_sample_size"] for exp in all_experiments]) if all_experiments else 0
            ),
        }
