...
class FeedbackProcessor:
    ...
    def _process_transaction_feedback(
        self, transaction_id: str, feedback_records: List[FeedbackRecord]
    ...
    def _resolve_feedback_conflicts(self, feedback_records: List[FeedbackRecord]) -> Tuple[FeedbackLabel, float]:
        ...
        for record in feedback_records:
            label = record.label
            weight = record.confidence * record.investigator_experience_score * record.feedback_consistency_score
    ...
    def _calculate_weighted_confidence(self, feedback_records: List[FeedbackRecord]) -> float:
        ...
        for record in feedback_records:
            weight = record.investigator_experience_score * record.feedback_consistency_score
