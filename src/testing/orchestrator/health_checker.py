...
class ServiceHealthChecker:
    ...
    async def check_service_health(self, service_name: str, health_check_url: str, 
                                 timeout: int = 30) -> HealthStatus:
        """
        ...
        try:
            ...
            self.logger.debug(
                f"Health check for {service_name}: {result.value} "
    ...
    async def _check_http_health(self, service_name: str, url: str, timeout: int) -> HealthStatus:
        ...
        try:
            ...
            if 200 <= response.status_code < 300:
                ...
                self.logger.warning(
                    f"HTTP health check for {service_name} returned {response.status_code}"
                )
                return HealthStatus.UNHEALTHY
            else:
                return HealthStatus.UNHEALTHY
    ...
    async def get_detailed_health_info(self, service_name: str, health_check_url: str, 
    ...
    async def _collect_service_diagnostics(self, service_name: str, health_check_url: str, 
