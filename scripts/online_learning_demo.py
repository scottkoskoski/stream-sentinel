...
class OnlineLearningDemo:
    ...
    async def _demo_model_registry(self):
        ...
        model_metadata = ModelMetadata(
            ...
            performance_metrics={"auc": 0.8723, "precision": 0.7845, "recall": 0.8234, "f1": 0.8032},
            validation_metrics={"auc": 0.8651, "precision": 0.7723, "recall": 0.8156, "f1": 0.7935},
        ...
        if success:
            ...
            deployed = self.model_registry.deploy_model(
                model_metadata.model_id, environment="staging", traffic_percentage=100.0
            )
