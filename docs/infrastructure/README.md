...
Stream-Sentinel's infrastructure demonstrates production-grade distributed systems patterns using containerized services orchestrated through Docker Compose. This guide explains both the technologies used and how they work together to create a resilient, high-performance fraud detection platform.
...
```
    ...
    │  │    :2181     │  │   :9092      │  │    :8081      │     │
    │  │              │  │              │  │              │     │
    │  │ Coordination │◄─┤ Message      │◄─┤ Data Format  │     │
    │  │ & Metadata   │  │ Streaming    │  │ Evolution    │     │
    │  └──────────────┘  └──────────────┘  └──────────────┘     │
    │                                                            │
    │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐     │
    │  │    Redis     │  │  Kafka UI    │  │Redis Insight │     │
    │  │    :6379     │  │    :8080     │  │    :8001     │     │
    │  │              │  │              │  │              │     │
    │  │ State Mgmt   │  │ Monitoring   │  │ Cache Monitor│     │
    │  │ & Caching    │  │ & Debug      │  │ & Debug      │     │
    │  └──────────────┘  └──────────────┘  └──────────────┘     │
    │                                                            │
    └─────────────────────────────────────────────────────────────┘
