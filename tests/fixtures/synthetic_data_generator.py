...
class SyntheticDataGenerator:
    ...
    def _load_ieee_patterns(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "temporal_patterns": {"peak_fraud_hour": 3, "peak_fraud_rate": 0.0650},
    ...
    def generate_transaction_amount(self, user_profile: UserProfile, is_fraud: bool = False) -> float:
        ...
        log_amount = np.random.lognormal(mean=np.log(base_amount), sigma=0.5)
    ...
    def generate_transaction_sequence(
        self,
        user_id: str,
        num_transactions: int,
        start_time: Optional[datetime] = None,
        fraud_injection_rate: float = 0.0,
    ) -> List[Dict[str, Any]]:
    ...
    def generate_performance_test_data(
        self, target_tps: int, duration_seconds: int, num_users: int = 10000
    ) -> List[Dict[str, Any]]:
        ...
        transactions = self.generate_bulk_transactions(num_transactions=total_transactions, num_users=num_users)
