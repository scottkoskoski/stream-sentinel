...
class TestFraudScoring:
    ...
    def test_rule_based_score_no_risk_factors(self):
        ...
        assert features.fraud_score == 0.0, (
            f"No risk factors should yield score 0.0, got {features.fraud_score}"
        )
    ...
    @pytest.mark.parametrize("amount,expected_risk,expected_min_score", [
    ...
    def test_threshold_determines_alert_flag(self):
        ...
        assert self.fraud_detector.fraud_threshold == 0.7
